library angulardraft.web.angulardraft.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"team": (o) => o.team,
  r"$event": (o) => o.$event,
  r"bidAmount": (o) => o.bidAmount,
  r"tooMuch": (o) => o.tooMuch,
  r"remaining": (o) => o.remaining,
  r"keyPressed": (o) => o.keyPressed
};
final Map<String, FieldSetter> setters = {
  ...
  r"ctrl": (o, v) => o.ctrl = v,
  r"player": (o, v) => o.player = v,
  r"Ign": (o, v) => o.Ign = v,
  r"status": (o, v) => o.status = v,
  r"bids": (o, v) => o.bids = v,
  r"bid": (o, v) => o.bid = v,
  r"team": (o, v) => o.team = v,
  r"$event": (o, v) => o.$event = v,
  r"bidAmount": (o, v) => o.bidAmount = v,
  r"tooMuch": (o, v) => o.tooMuch = v,
  r"remaining": (o, v) => o.remaining = v
};
